...
export const cardApi = {
  ...
  bulkAutoAssignDesigners: (cardIds) => api.post('/tasks/cards/bulk-auto-assign-designers', { cardIds }),
  bulkAutoSetCover: (cardIds) => api.post('/tasks/cards/bulk-auto-set-cover', { cardIds }),
  ...
  downloadCommentImagesZip: (cardId, commentId) => api.get(`/tasks/cards/${cardId}/comments/${commentId}/images/zip`, {
